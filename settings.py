...
DATABASES = {
    'default': {
        ...
        'NAME': 'opentracks',                      # Or path to database file if using sqlite3.
        'USER': 'opentracks',                      # Not used with sqlite3.
        'PASSWORD': 'XWDeaqWGZWHmHeCJ',                  # Not used with sqlite3.
...
SECRET_KEY = '636^=1(d^%vyfps$!xg90+e@&amp;9nkqtg-eb)w^@q-3!%2wl)oud'
